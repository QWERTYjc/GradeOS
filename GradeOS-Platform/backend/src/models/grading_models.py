...
class QuestionRubric:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "QuestionRubric":
        ...
        return cls(
            ...
            scoring_points=[ScoringPoint.from_dict(sp) for sp in data.get("scoring_points", [])],
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "QuestionResult":
        ...
        return cls(
            ...
            scoring_point_results=[
                ScoringPointResult.from_dict(spr) for spr in data.get("scoring_point_results", [])
            ],
...
class PageGradingResult:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PageGradingResult":
        ...
        return cls(
            ...
            question_results=[
                QuestionResult.from_dict(qr) for qr in data.get("question_results", [])
            ],
...
class BatchGradingResult:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "BatchGradingResult":
        ...
        return cls(
            ...
            student_results=[StudentResult.from_dict(sr) for sr in data.get("student_results", [])],
            total_pages=data.get("total_pages", 0),
            processed_pages=data.get("processed_pages", 0),
            cross_page_questions=[
                CrossPageQuestion.from_dict(cpq) for cpq in data.get("cross_page_questions", [])
            ],
...
class ErrorLog:
    ...
    @classmethod
    def create_now(cls, error_type: str, error_message: str, **kwargs) -> "ErrorLog":
        """创建当前时间的错误日志"""
        return cls(
