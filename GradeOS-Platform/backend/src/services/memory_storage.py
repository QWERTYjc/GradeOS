        ...
        try:
            async with self._pool_manager.pg_connection() as conn:
                ...
                return {
                    ...
                    "predicted_confidences": row["predicted_confidences"] if isinstance(row["predicted_confidences"], list) else json.loads(row["predicted_confidences"]),
                    "actual_accuracies": row["actual_accuracies"] if isinstance(row["actual_accuracies"], list) else json.loads(row["actual_accuracies"]),
                }
