...
class AnnotatedImageExporter:
    ...
    def __init__(self, config: Optional[ExportConfig] = None):
        ...
        self.renderer = AnnotationRenderer(RenderConfig(
        ...
        for q in question_results:
            ...
            for spr in q.get("scoringPointResults") or q.get("scoring_point_results") or []:
                ...
                if error_region:
                    ...
                    annotations.append(VisualAnnotation(
                        annotation_type=(
                            AnnotationType.CORRECT_CHECK if is_correct
            ...
            for step in q.get("steps") or []:
                ...
                if step_region:
                    ...
                    annotations.append(VisualAnnotation(
                        annotation_type=(
                            AnnotationType.STEP_CHECK if is_correct
    ...
    def render_student_pages(
        ...
        """
        rendered = []
        question_results = student_result.get("questionResults") or student_result.get("question_results") or []
    ...
    def export_to_zip(
        ...
        with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zf:
            for student in student_results:
                ...
                # 渲染该学生的页面
                rendered_pages = self.render_student_pages(
    ...
    def export_basic(
        ...
        if class_report:
            ...
            report_items = [
                ...
                ("平均得分率", f"{(class_report.get('averagePercentage') or class_report.get('average_percentage', 0)):.1f}%"),
                ("及格率", f"{(class_report.get('passRate') or class_report.get('pass_rate', 0)):.1f}%"),
            ...
            if weak_points:
                ws3.cell(row=len(report_items) + 2, column=1, value="薄弱知识点").font = Font(bold=True)
