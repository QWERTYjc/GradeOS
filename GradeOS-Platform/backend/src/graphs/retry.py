...
def create_retryable_node(
    ...
    fallback_func: Optional[Callable[[GradingGraphState, Exception], Awaitable[GradingGraphState]]] = None,
        ...
        try:
            ...
            if fallback_func:
                ...
                try:
                    ...
                    logger.error(f"降级逻辑也失败了: {type(fallback_error).__name__}: {fallback_error}")
                    # 降级也失败，记录错误到状态
