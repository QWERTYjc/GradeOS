...
async def get_rubric(exam_id: str, question_id: str) -> Rubric:
    ...
    **需求：9.2**
    ...
    try:
        ...
        scoring_points = [
            ScoringPoint(**point) for point in rubric.get("scoring_points", [])
        ]
