        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-50 transition-colors"
            >
              {loading ? '搜索中...' : '搜索'}
            </button>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            ...
            {results.map((result) => (
              <div
                key={result.post_id}
                onClick={() => router.push(`/student/openboard/post/${result.post_id}`)}
